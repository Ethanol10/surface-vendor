...
public final class Point {
    ...
    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.x))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.y))));
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        this.x = _hidl_blob.getInt32(0 + _hidl_offset);
        this.y = _hidl_blob.getInt32(4 + _hidl_offset);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        _hidl_blob.putInt32(0 + _hidl_offset, this.x);
        _hidl_blob.putInt32(4 + _hidl_offset, this.y);
    }
}