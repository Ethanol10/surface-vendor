package vendor.surface.displaytopology.V1_0;
...
public interface IDisplayTopology extends IBase {
    public static final String kInterfaceName = "vendor.surface.displaytopology@1.0::IDisplayTopology";
    ...
    int getBezelDefaultSize() throws RemoteException;

    int getBezelSize() throws RemoteException;

    int getComposition() throws RemoteException;
    ...
    int setBezelSize(int i) throws RemoteException;

    int setComposition(int i) throws RemoteException;
    ...
    public static final class DisplaysComposition {
        public static final int COMPOUND_DISPLAYS = 2;
        public static final int LEFT_DISPLAY = 0;
        public static final int RIGHT_DISPLAY = 1;
        public static final int SPLIT_DISPLAYS = 3;
        ...
        public static final String dumpBitfield(int o) {
            ...
            if ((o & 2) == 2) {
                list.add("COMPOUND_DISPLAYS");
                flipped |= 2;
            }
            if ((o & 3) == 3) {
                list.add("SPLIT_DISPLAYS");
                flipped |= 3;
            }
            if (o != flipped) {
    ...
    public static final class Proxy implements IDisplayTopology {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.surface.displaytopology@1.0::IDisplayTopology]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IDisplayTopology {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(IDisplayTopology.kInterfaceName, IBase.kInterfaceName));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-125, -38, -93, -58, 82, -3, 9, 32, -47, -71, 11, -1, 62, 46, 69, 61, -81, -103, 79, -83, -48, 82, -99, 75, -43, -28, -30, -94, -127, 70, -38, 0}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
